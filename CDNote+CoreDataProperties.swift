...
extension CDNote {
    ...
    func convertToNote() -> Note{
        return Note(id: self.id!, noteTitle: self.noteTitle, noteDescription: self.noteDescription, noteCategory: self.noteCategory, noteCreationDate: self.noteCreationDate, noteModificationDate: self.noteModificationDate, noteAttachment: self.noteAttachment, noteLock: self.noteLock)
    }
